...
update_cart_item_put_schema = extend_schema(
    tags=["Cart"],
    operation_id="update_cart_item",
    summary="Update Cart Item Quantity",
    description=(
...
update_cart_item_patch_schema = extend_schema(
    tags=["Cart"],
    operation_id="partial_update_cart_item",
    summary="Partially Update Cart Item",
    description="Partially updates a specific cart item.",
    request={
        "application/json": {
            "type": "object",
            "properties": {
